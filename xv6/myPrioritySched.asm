...
_myPrioritySched:     file format elf32-i386
  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  28:	74 26                	je     50 <main+0x50>
    pid = fork();
  2a:	e8 ec 02 00 00       	call   31b <fork>
    if (pid < 0)
  ...
  6a:	53                   	push   %ebx
  6b:	e8 63 03 00 00       	call   3d3 <setPriority>
      sleep(1);
  70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  77:	e8 37 03 00 00       	call   3b3 <sleep>
  7c:	83 c4 10             	add    $0x10,%esp
      for (j = 0; j < 10000000; j++)
  7f:	d9 ee                	fldz   
  81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  88:	d8 05 38 08 00 00    	fadds  0x838
  8e:	d9 05 3c 08 00 00    	flds   0x83c
  94:	df f1                	fcomip %st(1),%st
  96:	77 f0                	ja     88 <main+0x88>
  98:	dd d8                	fstp   %st(0)
      printf(1, "Child pid %d and child priority : %d\n", getpid(), getPriority());
  9a:	e8 3c 03 00 00       	call   3db <getPriority>
  9f:	89 c3                	mov    %eax,%ebx
  a1:	e8 fd 02 00 00       	call   3a3 <getpid>
  a6:	53                   	push   %ebx
  a7:	50                   	push   %eax
  a8:	68 10 08 00 00       	push   $0x810
  ad:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 40 08 00 00       	mov    $0x840,%ebx
        while(*s != 0){
