...
_mydate:     file format elf32-i386
...
if (mydate(&r)) {
  12:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  15:	83 ec 30             	sub    $0x30,%esp
if (mydate(&r)) {
  18:	50                   	push   %eax
  19:	e8 95 03 00 00       	call   3b3 <mydate>
...
printf(2, "date failed\n");
  25:	52                   	push   %edx
  26:	52                   	push   %edx
  27:	68 f8 07 00 00       	push   $0x7f8
  2c:	6a 02                	push   $0x2
  2e:	e8 5d 04 00 00       	call   490 <printf>
exit();
  33:	e8 db 02 00 00       	call   313 <exit>
}
...
printf(1,"Year: %d\n",r.year);
  ...
  3c:	68 05 08 00 00       	push   $0x805
  41:	6a 01                	push   $0x1
  43:	e8 48 04 00 00       	call   490 <printf>
printf(1,"Month: %d\n",r.month);
  48:	83 c4 0c             	add    $0xc,%esp
  4b:	ff 75 f0             	pushl  -0x10(%ebp)
  4e:	68 0f 08 00 00       	push   $0x80f
  53:	6a 01                	push   $0x1
  55:	e8 36 04 00 00       	call   490 <printf>
printf(1,"Date: %d\n",r.day);
  5a:	83 c4 0c             	add    $0xc,%esp
  5d:	ff 75 ec             	pushl  -0x14(%ebp)
  60:	68 1a 08 00 00       	push   $0x81a
  65:	6a 01                	push   $0x1
  67:	e8 24 04 00 00       	call   490 <printf>
printf(1,"Hour: %d\n",r.hour);
  6c:	83 c4 0c             	add    $0xc,%esp
  6f:	ff 75 e8             	pushl  -0x18(%ebp)
  72:	68 24 08 00 00       	push   $0x824
  77:	6a 01                	push   $0x1
  79:	e8 12 04 00 00       	call   490 <printf>
printf(1,"Minute: %d\n",r.minute);
  7e:	83 c4 0c             	add    $0xc,%esp
  81:	ff 75 e4             	pushl  -0x1c(%ebp)
  84:	68 2e 08 00 00       	push   $0x82e
  89:	6a 01                	push   $0x1
  8b:	e8 00 04 00 00       	call   490 <printf>
printf(1,"Second: %d\n",r.second);
  90:	83 c4 0c             	add    $0xc,%esp
  93:	ff 75 e0             	pushl  -0x20(%ebp)
  96:	68 3a 08 00 00       	push   $0x83a
  9b:	6a 01                	push   $0x1
  9d:	e8 ee 03 00 00       	call   490 <printf>
Hour: 15
Minute: 12
Second: 11
*/
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 46 08 00 00       	mov    $0x846,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 ...
 7be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	bf fc 0a 00 00       	mov    $0xafc,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 7d6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 7e2:	00 00 00 
    if(p->s.size >= nunits){
