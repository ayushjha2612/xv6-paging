...
_mydemandPage:     file format elf32-i386
...
int main()
{
   ...
   f:	c7 05 20 0b 00 00 02 	movl   $0x2,0xb20
  16:	00 00 00 
{
  ...
  1c:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  25:	68 20 0b 00 00       	push   $0xb20
  2a:	68 f8 07 00 00       	push   $0x7f8
  2f:	6a 01                	push   $0x1
  31:	e8 5a 04 00 00       	call   490 <printf>
    {
        glob[i] = glob[i - 1];
  36:	a1 20 0b 00 00       	mov    0xb20,%eax
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	a3 24 0b 00 00       	mov    %eax,0xb24
        if (i % 1000 == 0)
  43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  47:	90                   	nop
    for (int i = 1; i < N; i++)
  48:	83 c3 01             	add    $0x1,%ebx
  4b:	81 fb b8 0b 00 00    	cmp    $0xbb8,%ebx
  51:	74 2e                	je     81 <main+0x81>
        glob[i] = glob[i - 1];
  53:	8b 04 9d 1c 0b 00 00 	mov    0xb1c(,%ebx,4),%eax
  5a:	89 04 9d 20 0b 00 00 	mov    %eax,0xb20(,%ebx,4)
  61:	69 c3 d5 78 e9 26    	imul   $0x26e978d5,%ebx,%eax
  67:	c1 c8 03             	ror    $0x3,%eax
        if (i % 1000 == 0)
  6a:	3d 37 89 41 00       	cmp    $0x418937,%eax
  6f:	77 d7                	ja     48 <main+0x48>
            mypgtPrint();
  71:	e8 45 03 00 00       	call   3bb <mypgtPrint>
    for (int i = 1; i < N; i++)
  76:	83 c3 01             	add    $0x1,%ebx
  79:	81 fb b8 0b 00 00    	cmp    $0xbb8,%ebx
  7f:	75 d2                	jne    53 <main+0x53>
    }
    printf(1, "Printing final page table:\n");
  81:	83 ec 08             	sub    $0x8,%esp
  84:	68 19 08 00 00       	push   $0x819
  89:	6a 01                	push   $0x1
  8b:	e8 00 04 00 00       	call   490 <printf>
    mypgtPrint();
  90:	e8 26 03 00 00       	call   3bb <mypgtPrint>
    printf(1, "Value: %d\n", glob[N - 1]);
  95:	83 c4 0c             	add    $0xc,%esp
  98:	ff 35 fc 39 00 00    	pushl  0x39fc
  9e:	68 35 08 00 00       	push   $0x835
  a3:	6a 01                	push   $0x1
  a5:	e8 e6 03 00 00       	call   490 <printf>
    exit();
  aa:	e8 64 02 00 00       	call   313 <exit>
  af:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 4d9:	e8 55 fe ff ff       	call   333 <write>
 ...
 539:	e8 f5 fd ff ff       	call   333 <write>
        putc(fd, c);
      } else {
 ...
 5c1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5c4:	e8 6a fd ff ff       	call   333 <write>
        ap++;
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 40 08 00 00       	mov    $0x840,%ebx
        while(*s != 0){
 ...
 63b:	57                   	push   %edi
 63c:	53                   	push   %ebx
 63d:	e8 f1 fc ff ff       	call   333 <write>
        while(*s != 0){
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 75b:	e8 3b fc ff ff       	call   39b <sbrk>
  if(p == (char*)-1)
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 00 0b 00 00       	mov    0xb00,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 7e2:	00 00 00 
    if(p->s.size >= nunits){
